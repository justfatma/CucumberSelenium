...
public class TaggedHooksStepDefinition {
	...
	@Before(order=0)
	public void setUP(){
		System.out.println("launch FF before order=0");
		System.out.println("Enter URL for Free CRM APP before order=0");
	}

	@After(order=0)
	public void tearDown(){
		System.out.println("close the browser after order=0");
	}
